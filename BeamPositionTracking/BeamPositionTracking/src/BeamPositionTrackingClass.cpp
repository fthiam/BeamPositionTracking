...
void BeamPositionTrackingClass::attribute_factory(vector<Tango::Attr *> &att_list)
{
	...
	//	Attribute : fixMode
	fixModeAttrib	*fix_mode = new fixModeAttrib();
	att_list.push_back(fix_mode);
...
void BeamPositionTrackingClass::set_default_property()
{
	...
	prop_name = "FixXWarningZoneCenter";
	...
	prop_name = "FixYWarningZoneCenter";
	...
	prop_name = "FixWarningZoneRadius";
